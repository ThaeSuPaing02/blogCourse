...
@section('content')
    ...
    <div class="container   mx-auto  flex justify-center">
        ...
        <div
            ...
            <h1 class="text-xl text-center font-semibold"> <i class="fa-solid fa-envelope"></i> Create Course Here</h1>
            <hr>
            <form action="{{ route('course#create') }}" method="post" class="mt-6" enctype="multipart/form-data">
                @csrf
                <div class="mb-6 ">
